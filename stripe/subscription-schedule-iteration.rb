...
retrieved_one_iteration_phase_subscription_schedule = Stripe::SubscriptionSchedule.retrieve(id: one_iteration_phase_subscription_schedule.id, expand: ['subscription'])

put_subscription_schedule(retrieved_one_iteration_phase_subscription_schedule, 'CREATED')

puts '-' * 100
puts "Subscription"
puts retrieved_one_iteration_phase_subscription_schedule.subscription