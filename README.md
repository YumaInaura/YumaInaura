...
- 0->1のサービス開発です (MVP版)
- 大きなプロジェクトのサブプロジェクトとして始まりました
- 初期開発は、開発者は自分1人だけで始まり、粗くスクラッチで必要な機能をだいたい作り上げました。 ( Nuxt + Rails )
- 数ヶ月後に計3人の開発メンバー/デザイナが加わりチーム開発が始まりましたが、自然的に自分がチームリーダー・スクラムマスター的な役割を担いました。 (その後も継続)
- 開発の全体を把握して、クライアントとの定例会議でもファシリテーション(司会進行)をしています。
