...
経験した言語・フレームワークがすごく多いとは言えませんが「ひとつを極めれば他も学習しやすい」というのは実感しています。
...
- プロダクト志向で、ビジネス視点も理解しながら開発を進められるエンジニアです。
- オーナーシップを持って物事を前に進められるエンジニアです。
- 開発全体や自分個人のパフォーマンスの向上を測り、常にコスト対パフォーマンスを考えるエンジニアです。
- 学習能力のあるエンジニアです。自分が未経験の事柄でも、経験すればスキルが身につくものだと実感で理解してします。

## 人からの評価

概して自己評価よりも他者からの評価の方が正確なものです。

自分が今まで人から言われた評価を並べてみます。
