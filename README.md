...
[プロフィール](#プロフィール) / [経歴要約](#経歴要約) / [スキルセット・経験](#スキルセット・経験) / [パーソナリティ](#パーソナリティ) /  [職務経歴](#職務経歴) / [Q&A](#Q&A) / [趣味](#趣味) / [ブログ](#ブログ) / [ご連絡フォーム](#ご連絡フォーム) 
...
- 自分が未経験の事柄でも、経験すればスキルが身につくものだと実感で理解してします。
...
サービス開発がひとつのミッションだとすれば、あらゆる面で自分のパフォーマンスを発揮して遂行することにモチベーションを感じます。

## ボトムアッフ型

スキル習得はトップダウン式ではなくてボトムアップ式です。

プロジェクトの業務の中で必要なこと全てを習得しています。そして、それがコストパフォーマンス最高の習得法だと思っています。

まずは体系的に物事を理解するトップダウンの学者肌ではありません。

## キャッチアップ

新しい技術のキャッチアップに関してはアーリーマジョリティ、もしくはレイトマジョリティです。

ですが周囲にアーリーアダプタの人がおり、良いツール、方式を勧めてくれる場合には、自分でも積極的に試すことが多いです。
...
自分の開発でもそうですし、チームとのディスカッションでもそうですし、クライアントにも複数の提案をすることが多いです。

## 人からの評価

概して自己評価よりも他者からの評価の方が正確だと言います。

今まで人から言われたことのある評価は次のようなものです。
...
-  エンジニアリング、チームリード、マネージメントのそれぞれに興味があります。
...
- あらゆる開発にはコミュニケーション能力は必須だと思いますが、自分の場合は特に言語すというものに気をつけるタイプだと思います。
- クライアントとの対話、チームとのコミュニケーション、プロジェクト課題を文章でまとめる時や、 PR の概要を書く時など、人に分かりやすい言葉、文章を心がけています。
- 昔から文章を書くことを趣味にしたり、読書量が多かったり、日頃から技術ブログを書いたりしていて鍛えられている素養だと思っています。

## レスポンス

- 非同期のコミュニケーション (チャットなど) におけるレスポンスは早めだと思います。
- また、忘れずに返事を返すよう心がけています。
...
- 大局観を持っています。些末な事柄に関しては、議論するほうが時間がもったいないと思うタイプです。熟慮すべき事柄は熟慮しますが、そうでない事柄は素早く判断して物事を前に進めたいと思っています。
- 人が気が付かないような細部によく気がつくことが多いです。物事に対して常に疑問を持ち、批判的思考で考えています。 

## 苦手なこと

- 堅苦しい組織だと窮屈さを感じてしまい、合わない気がします。カジュアルな文化が好きです。
- 単純作業は苦手です。プログラマとしては当たり前かもしれませんが、もちろん頭を使う仕事の方が好きです。 (でも誰かがやらなければいけない単純作業であれば、引き受けもします)
