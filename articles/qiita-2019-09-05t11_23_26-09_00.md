---
title: "#Ruby で HTML を PDF に変換・保存する ( pdfkit + wkhtmltopdf-binary ) ( #Mac 環境 "
emoji: "🖥"
type: "tech"
topics: ["Ruby", "Mac"]
published: true
published_at: 2019-09-05t11:23
---
...
```
docker run -it -v /tmp/:/tmp ruby bin/bash
```
...
```rb
require 'pdfkit'
pdf_file = PDFKit.new('<h1>hello</h1>', :page_size => 'Letter').to_pdf
File.write('/tmp/some.pdf', pdf_file)

```

# Mac問題？

Macで試すと、なぜかフォントサイズが小さい。Macの問題かも？です。 @QUANON さんありがとうございます。


[some1.pdf](https://github.com/YumaInaura/door/files/3577017/some1.pdf)

![image](https://user-images.githubusercontent.com/13635059/64303747-7d0c2b80-cfc4-11e9-8d97-2794ff3f9799.png)

# pdfkit - オンラインのHTML変換

```
pdf_file = PDFKit.new('https://www.google.com', :page_size => 'Letter').to_pdf
File.write('/tmp/google.pdf', pdf_file)
```
...
```
wkhtmltopdf https://google.com/ /tmp/google.pdf
```

![image](https://user-images.githubusercontent.com/13635059/64303781-9e6d1780-cfc4-11e9-9017-cdbc58357292.png)
[google.pdf](https://github.com/YumaInaura/door/files/3577018/google.pdf)

 # wkhtmltopdfのヘルプ

かなり豊富なオプションがあって、細かい制御までできそうな感じ。
...
https://github.com/YumaInaura/YumaInaura/issues/2390
